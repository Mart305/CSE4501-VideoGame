...
namespace StarterAssets
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
		...
		/// <summary>
		/// Finds and caches the MainCamera reference. Called when camera is null or destroyed.
		/// </summary>
		...
		private void Move()
		{
			...
			if (_input.move != Vector2.zero) {
				// FIXED: Check if camera is valid before accessing its transform (LINE 209 FIX)
				if (_mainCamera != null) {
					...
					// Fallback: rotate based on input direction only (no camera influence)
